...
from model_factory import build_alexnet
...
def run_export():
    ...
    model.load_weights("results/ALEXNET/ALEXNET_best_weights.h5")
    export_model(model, model_name="ALEXNET", export_dir="exports/alexnet")
