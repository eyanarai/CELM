...
from model_factory import build_densenet121
...
def run_export():
    ...
    model.load_weights("results/DENSENET121/DENSENET121_best_weights.h5")
    export_model(model, model_name="DENSENET121", export_dir="exports/densenet121")
