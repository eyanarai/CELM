...
from model_factory import build_densenet201
...
def run_export():
    model = build_densenet201(input_shape=(224, 224, 3))
    model.load_weights("results/DENSENET201/DENSENET201_best_weights.h5")
    export_model(model, model_name="DENSENET201", export_dir="exports/densenet201")
